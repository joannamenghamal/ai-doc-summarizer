            ...
            <div className="bg-white p-6 sm:p-8 md:p-10 rounded-3xl shadow-2xl w-full max-w-xl md:max-w-3xl">
                ...
                <div className={activeTab === 'file' ? '' : 'hidden'}>
                    ...
                    <input
                        ...
                        id="file-upload"
                        accept=".pdf,.doc,.txt"
                        className="text-black w-full p-2 sm:p-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200"
                        onChange={(e) => {
